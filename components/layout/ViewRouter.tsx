// components/layout/ViewRouter.tsx - Version 10.4.0 (Anti-Flash & Splash Screen)
...
export const ViewRouter = ({ engine }: { engine: any }) => {
    ...
    // Cela évite de voir le bloc noir de la sonde ou le dashboard vide
